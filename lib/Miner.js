...
class Miner {
  ...
  mine(rewardAddress, feeAddress) {
    ...
    const thread = spawn(function (input, done) {
      /*eslint-disable */
      require(input.__dirname + "/utils/consoleWrapper.js")(
        "mine-worker",
        input.logLevel
      );
      const Block = require(input.__dirname + "/Block.js");
      const Miner = require(input.__dirname + "/Miner.js");
      /*eslint-enable */
  ...
  static generateNextBlock(rewardAddress, feeAddress, blockchain) {
    ...
    let transactions = R.defaultTo(
      [],
      R.take(TRANSACTIONS_PER_BLOCK, selectedTransactions)
    );
